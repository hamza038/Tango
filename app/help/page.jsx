...
const Page = () => {
  return (
    <div>
      ...
      <div className="">
        <h1 className="text-center text-4xl mt-[40px] md:font-bold">
          Results for"Transfers"
        </h1>
        <div className="ml-[70px] mt-[100px]">
          <h1 className=" md:font-bold">Why was my transfer cancelled</h1>
          <h4>
            Some time tangopay cancel your transfer.They are the few reason why
            we might do this-here are some of most common onces.
          </h4>
          <h1 className="md:font-bold mt-[30px]">
